    ...
    <div class="flex  justify-center items-center min-h-full w-full min-w-full">
        <div class="flex">
            ...
            <div class="px-8 ">
                ...
                <div>
                    <router-link :to="{name: 'app.dashboard'}" class="rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Go back home
                    </router-link>
                </div>
            </div>
